...
const VJRenderer = forwardRef<VJRendererRef, VJRendererProps>(({ videoSourceA, videoSourceB, opacityA, opacityB, mixBlendModeB }, ref) => {
    ...
    // Refs to store latest props for use in render loop without restarting it
    ...
    }, []); // Empty dependency array means loop runs once and never stops
